...
class PositionTestPage(RecognitionBasePage):
    ...
    def _do_recognition(self):
        ...
        try:
            ...
            # 计算左3上5的位置
            x1 = grid_start_x + (2 * cell_size) + (cell_size / 2)  # 左3，从0开始计数所以是2
            y1 = grid_start_y + (4 * cell_size) + (cell_size / 2)  # 上5，从0开始计数所以是4
            
            # 计算左5上10的位置
            x2 = grid_start_x + (4 * cell_size) + (cell_size / 2)  # 左5，从0开始计数所以是4
            y2 = grid_start_y + (9 * cell_size) + (cell_size / 2)  # 上10，从0开始计数所以是9
